...
=== "ModBlockEntities"
    ...
    public class ModBlockEntities {
        ...
        public static final BlockEntityType<ExampleBlockEntity> EXAMPLE_BLOCK_ENTITY = 
                Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(Main.MOD_ID, "example_be"),
                        abricBlockEntityTypeBuilder.create(ExampleBlockEntity::new,
                                ModBlocks.EXAMPLE_BLOCK).build()); // (1)
